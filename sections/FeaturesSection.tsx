...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32 text-white">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        <Image className="h-full w-auto" src="/features-showcase-1.png" alt="features showcase" width={1000} height={500} />
                    </motion.div>
                    ...
                    >
                        <Image src="/features-showcase-2.png" alt="features showcase" width={1000} height={500} className="hover:-translate-y-0.5 transition duration-300" />
